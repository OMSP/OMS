        ...
        $config = [
            // Meta and titles
            'title'             => "Website", // Title, used all over the site.
            'logo'              => "http://localhost/", // Logo, must be a direct url or direct path to file, used all over the site.
            'alt'               => "Alternative", // Alternative, used when the logo does not load, mainly in meta.
            'favicon'           => "http://localhost/", // Favicon, must be a direct url or direct path to file, used all over the site.
            'description'       => "This is very nice site, I like", // Description, used for meta purposes.
            'author'            => "Calvin Heldoorn", // Website author, your name or alias, used for meta purposes.
            'keywords'          => "drawing, design, cool stuff", // Keywords, please divide all keywords using a comma, used for meta purposes.
            'country_lang'      => "NL", // Country and language, if you don't know what to put here, don't change it, used for meta purposes.
            ...
            'lang'              => "en", //set a supported country code (en, nl).
        ...
        $config["omsfullver"] = "OMS R".$config['corever']." (".$config['corever'].".".$config['corevernr']."-".$config['corestatus'].")";
